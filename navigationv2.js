(function() {
    ...
    // Navigation CSS. Colors come from the theme.css custom properties, so
    // every page must link theme.css; light/dark switch with the page.
    ...
    function injectStyles() {
        ...
        style.textContent = themedNavStyles;
    ...
    function init() {
        ...
        const navHTML = generateThemedNavHTML(currentPage);

        const tempDiv = document.createElement('div');
        tempDiv.innerHTML = navHTML;
        const navElement = tempDiv.firstElementChild;

        // Keep the skip link as the first tab stop
