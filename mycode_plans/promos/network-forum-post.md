I built a collection of web utilities that might be useful if you work in networking or sysadmin. It's at www.oldweb.tech
...
Everything runs in your browser with no backend, so it works offline once you load it. No tracking, no analytics, no account signup. Just open it and use it. The tools are pretty fast since everything is client side.
